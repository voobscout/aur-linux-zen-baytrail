...
source=("https://www.kernel.org/pub/linux/kernel/v4.x/${_srcname}.tar.xz"
        ...
        "${_rtl8723bs_name}::git+https://github.com/ferbar/rtl8723bs"
        )
...
prepare() {
  ...
  # Patches for Baytrail devices and specifically rtl8723bs
  # https://github.com/ferbar/rtl8723bs/tree/master/patches_4.7

  msg "Running 0001-My-changes-for-4.7.0-rc7-for-Baytrail-T.patch"
  patch -p1 -i "${srcdir}/${_rtl8723bs_name}/patches_4.7/0001-My-changes-for-4.7.0-rc7-for-Baytrail-T.patch"

  msg "Running 0002-My-changes-for-4.7.0-rc7-for-Baytrail-T-sound.patch"
  patch -p1 -i "${srcdir}/${_rtl8723bs_name}/patches_4.7/0002-My-changes-for-4.7.0-rc7-for-Baytrail-T-sound.patch"
